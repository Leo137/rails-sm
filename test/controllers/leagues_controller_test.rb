...
class LeaguesControllerTest < ActionController::TestCase
  ...
  test "should create league" do
    assert_difference('League.count') do
      post :create, league: { description: @league.description, name: @league.name, organizer_id: @league.organizer_id }
    end
  ...
  test "should update league" do
    patch :update, id: @league, league: { description: @league.description, name: @league.name, organizer_id: @league.organizer_id }
    assert_redirected_to league_path(assigns(:league))
  end
